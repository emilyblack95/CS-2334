...
public class CompareLastNameTest {
	...
	public void test() {
		...
		Person personA = new Person(new Name("Taylor", "Swift"), "13/12/1989", "City", "State");
		Person personB = new Person(new Name("Andrea", "Swift"), "13/12/1960", "City", "State");
		...
		Person personC = new Person(new Name("Miley", "Cyrus"), "23/11/1992", "City", "State");
		...
		Person personD = new Person(new Name("Justin", "Timberlake"), "31/01/1981", "City", "State");
