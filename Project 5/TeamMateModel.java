...
public class TeamMateModel implements Serializable{
    ...
    */
    ...
    private static ArrayList<City> listOfCities;
    private ArrayList<State> states = new ArrayList<State>();
    private static ArrayList<Person> listOfPlayers;
    ...
    TeamMateModel(ArrayList<Team> listOfTeams, ArrayList<City> listOfCities, ArrayList<Person> listOfPlayers){
        TeamMateModel.listOfTeams = listOfTeams;
        TeamMateModel.listOfCities = listOfCities;
        TeamMateModel.listOfPlayers = listOfPlayers;
    }
    ...
    public void addTeam(Team team){
    	TeamMateModel.listOfTeams.add(team);
    	TeamMateModel.teamMap.put(team.getID(), team);
    }
    /**
    ...
    public void addPerson(Person person){
    	TeamMateModel.listOfPlayers.add(person);
    }
    /**
    ...
    public void addPlace(String cityName, State state){
    	TeamMateModel.listOfCities.add(new City(cityName, state));
    }
    ...
    public void setPeople(ArrayList<Person> people){
        TeamMateModel.listOfPlayers = people;
     ...
     * @throws IOException 
     */
    public static void fillArrayList(String fileName) throws IOException
    {
        ...
        br.close();
        //processEvent( new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "people entered")); error because this method is static
    }
     ...
     * @throws IOException 
     */
    public static void fillTeamMap(String fileName) throws IOException
    {
        teamMap = new LinkedHashMap<String, Team>();
        FileReader fr = new FileReader(fileName);
        BufferedReader br = new BufferedReader(fr);
        ...
        //processEvent( new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "teams entered")); ERROR, wanted to be static
    }
