...
public class SelectionView extends JFrame {
	...
	public SelectionView(TeamMateModel model){
		...
		jbtEditPlace.setEnabled(false);
		jbtDeletePlace.setEnabled(false);
		jbtEditPerson.setEnabled(false);
		jbtDeletePerson.setEnabled(false);
		jbtEditTeam.setEnabled(false);
		jbtDeleteTeam.setEnabled(false);
		...
		jpPlaceButtons.add(jbtAddPlace);
		jpPlaceButtons.add(jbtEditPlace);
		jpPlaceButtons.add(jbtDeletePlace);
		...
		jpPersonListPanel.add(personLabel);
		jpPersonListPanel.add(jspPerson);
		...
		jpPersonButtons.add(jbtAddPerson);
		jpPersonButtons.add(jbtEditPerson);
		jpPersonButtons.add(jbtDeletePerson);
		...
		//jbtAddPerson.addActionListener(this); 
		//TODO: register & add action listeners for ALL buttons
	...
	/**
	 * Mutator - sets the controller for this view class
	 * @param controller
	 */
	public void setController(TeamMateController controller){
		this.controller = controller;
	}
	
	//TODO: updateView(TeamMateModel model) method? When data fields change after entry? WHAT TO DO?
